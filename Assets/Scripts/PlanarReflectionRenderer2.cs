...
namespace StylizedWater2
{
    ...
    public class PlanarReflectionRenderer2 : MonoBehaviour
    {
        public static List<PlanarReflectionRenderer2> Instances = new List<PlanarReflectionRenderer2>();
        ...
        public static void SetQuality(bool enableReflections, float renderScale = -1f, float renderRange = -1f, int maxLodLevel = -1)
        {
            ...
            foreach (PlanarReflectionRenderer2 renderer in Instances)
            {
