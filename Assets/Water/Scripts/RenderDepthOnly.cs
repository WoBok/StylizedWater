...
public class RenderDepthOnly : ScriptableRendererFeature
{
    ...
    public class RenderDepthOnlyPass : ScriptableRenderPass
    {
        RTHandle m_RTHandle;
        ...
        public override void OnCameraSetup(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            RenderingUtils.ReAllocateIfNeeded(ref m_RTHandle, descriptor, name: "_CameraDepthTexture");
        ...
        public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
        {
            ...
            cmd.SetGlobalTexture("_CameraDepthTexture", m_RTHandle);
